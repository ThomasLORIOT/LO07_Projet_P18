...
<!DOCTYPE html>
<!--
    Page admin pour la gestion des nounous
        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                ...
                <div class="col-sm-2 sidenav">
                    ...
                    formInput("<h5 class='text-success'>Entrer idNounou à rendre visible</h5>", "text", "idVal");
                    echo("<hr>");
                    formInput("<h5 class='text-danger'>Entrer idNounou à rendre invisible</h5>", "text", "idSup");
                    formAddSubmitReset("Confirmer");
                    finForm();
                    ?>
                </div>
