...
<html>
    <head>
        <title>Ajout enfant à garde</title>
        <meta charset="UTF-8">
        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                ...
                <div class="col-sm-8 text-left"> 
                    <h1>Vérification :</h1>
                    <?php
                    if(isset($_POST['idEnfant'])&& isset($_POST['idNounou'])&& isset($_POST['idHoraire'])){
                        if ($parent->addEnfantGarde($_POST['idEnfant'], $_POST['idNounou'], $_POST['idHoraire'])){
                            echo("L'enfant à bien été ajouté à la garde");
                        }
                    } else {
                        echo("Enfant non ajouté à la garde");
                    }
                    ?>
                </div>
                <div class="col-sm-2 sidenav">
